...
//		System.out.println("les villageois on bien ete ajouter ");
		...
		Etal etalFleur = village.rechercherEtalVendeur(bonemine);
		System.out.println(etalFleur.acheterProduit(10, abraracourcix));//errr
